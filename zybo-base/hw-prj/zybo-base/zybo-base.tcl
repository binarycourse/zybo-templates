...
#
# zybo-base.tcl: Tcl script for re-creating project 'zybo-base'
#
# Generated by Vivado on Mon May 25 20:20:43 +0430 2020
...
#
# 1. This project restoration tcl script (zybo-base.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "./zybo-base.srcs/sources_1/bd/zybo/hdl/zybo_wrapper.v"
#    "./zybo-base.srcs/constrs_1/new/zybo-base.xdc"
#
...
set files [list \
 [file normalize "${origin_dir}/zybo-base.srcs/sources_1/bd/zybo/hdl/zybo_wrapper.v" ]\
]
...
set obj [get_filesets sources_1]
set_property -name "top" -value "zybo_wrapper" -objects $obj
...
set file "[file normalize "$origin_dir/zybo-base.srcs/constrs_1/new/zybo-base.xdc"]"
set file_imported [import_files -fileset constrs_1 [list $file]]
set file "new/zybo-base.xdc"
set file_obj [get_files -of_objects [get_filesets constrs_1] [list "*$file"]]
set_property -name "file_type" -value "XDC" -objects $file_obj

# Set 'constrs_1' fileset properties
set obj [get_filesets constrs_1]
set_property -name "target_constrs_file" -value "[get_files *new/zybo-base.xdc]" -objects $obj
set_property -name "target_ucf" -value "[get_files *new/zybo-base.xdc]" -objects $obj
...
# Proc to create BD zybo
proc cr_bd_zybo { parentCell } {
  ...
  # Create instance: bram_gen, and set properties
  ...
  # Create instance: gpio_swtchs, and set properties
  set gpio_swtchs [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 gpio_swtchs ]
  set_property -dict [ list \
  ...
  # Create instance: rst_zynq7010_100M, and set properties
  set rst_zynq7010_100M [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 rst_zynq7010_100M ]

  # Create instance: zynq7010, and set properties
  set zynq7010 [ create_bd_cell -type ip -vlnv xilinx.com:ip:processing_system7:5.5 zynq7010 ]
  set_property -dict [ list \
  ...
  # Create instance: zynq7010_axi_periph, and set properties
  set zynq7010_axi_periph [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_interconnect:2.1 zynq7010_axi_periph ]
  set_property -dict [ list \
   CONFIG.NUM_MI {4} \
 ] $zynq7010_axi_periph

  # Create interface connections
  connect_bd_intf_net -intf_net axi_gpio_0_GPIO [get_bd_intf_ports leds_4bits] [get_bd_intf_pins gpio_leds/GPIO]
  connect_bd_intf_net -intf_net axi_gpio_0_GPIO1 [get_bd_intf_ports btns_4bits] [get_bd_intf_pins gpio_btns/GPIO]
  connect_bd_intf_net -intf_net axi_gpio_0_GPIO2 [get_bd_intf_ports sws_4bits] [get_bd_intf_pins gpio_swtchs/GPIO]
  connect_bd_intf_net -intf_net bram_ctrl_BRAM_PORTA [get_bd_intf_pins bram_ctrl/BRAM_PORTA] [get_bd_intf_pins bram_gen/BRAM_PORTA]
  connect_bd_intf_net -intf_net bram_ctrl_BRAM_PORTB [get_bd_intf_pins bram_ctrl/BRAM_PORTB] [get_bd_intf_pins bram_gen/BRAM_PORTB]
  connect_bd_intf_net -intf_net processing_system7_0_DDR [get_bd_intf_ports DDR] [get_bd_intf_pins zynq7010/DDR]
  connect_bd_intf_net -intf_net processing_system7_0_FIXED_IO [get_bd_intf_ports FIXED_IO] [get_bd_intf_pins zynq7010/FIXED_IO]
  connect_bd_intf_net -intf_net zynq7010_M_AXI_GP0 [get_bd_intf_pins zynq7010/M_AXI_GP0] [get_bd_intf_pins zynq7010_axi_periph/S00_AXI]
  connect_bd_intf_net -intf_net zynq7010_axi_periph_M00_AXI [get_bd_intf_pins gpio_leds/S_AXI] [get_bd_intf_pins zynq7010_axi_periph/M00_AXI]
  connect_bd_intf_net -intf_net zynq7010_axi_periph_M01_AXI [get_bd_intf_pins gpio_btns/S_AXI] [get_bd_intf_pins zynq7010_axi_periph/M01_AXI]
  connect_bd_intf_net -intf_net zynq7010_axi_periph_M02_AXI [get_bd_intf_pins gpio_swtchs/S_AXI] [get_bd_intf_pins zynq7010_axi_periph/M02_AXI]
  connect_bd_intf_net -intf_net zynq7010_axi_periph_M03_AXI [get_bd_intf_pins bram_ctrl/S_AXI] [get_bd_intf_pins zynq7010_axi_periph/M03_AXI]

  # Create port connections
  connect_bd_net -net gpio_btns_ip2intc_irpt [get_bd_pins gpio_btns/ip2intc_irpt] [get_bd_pins zynq7010/IRQ_F2P]
  connect_bd_net -net rst_zynq7010_100M_peripheral_aresetn [get_bd_pins bram_ctrl/s_axi_aresetn] [get_bd_pins gpio_btns/s_axi_aresetn] [get_bd_pins gpio_leds/s_axi_aresetn] [get_bd_pins gpio_swtchs/s_axi_aresetn] [get_bd_pins rst_zynq7010_100M/peripheral_aresetn] [get_bd_pins zynq7010_axi_periph/ARESETN] [get_bd_pins zynq7010_axi_periph/M00_ARESETN] [get_bd_pins zynq7010_axi_periph/M01_ARESETN] [get_bd_pins zynq7010_axi_periph/M02_ARESETN] [get_bd_pins zynq7010_axi_periph/M03_ARESETN] [get_bd_pins zynq7010_axi_periph/S00_ARESETN]
  connect_bd_net -net zynq7010_FCLK_CLK0 [get_bd_pins bram_ctrl/s_axi_aclk] [get_bd_pins gpio_btns/s_axi_aclk] [get_bd_pins gpio_leds/s_axi_aclk] [get_bd_pins gpio_swtchs/s_axi_aclk] [get_bd_pins rst_zynq7010_100M/slowest_sync_clk] [get_bd_pins zynq7010/FCLK_CLK0] [get_bd_pins zynq7010/M_AXI_GP0_ACLK] [get_bd_pins zynq7010_axi_periph/ACLK] [get_bd_pins zynq7010_axi_periph/M00_ACLK] [get_bd_pins zynq7010_axi_periph/M01_ACLK] [get_bd_pins zynq7010_axi_periph/M02_ACLK] [get_bd_pins zynq7010_axi_periph/M03_ACLK] [get_bd_pins zynq7010_axi_periph/S00_ACLK]
  connect_bd_net -net zynq7010_FCLK_RESET0_N [get_bd_pins rst_zynq7010_100M/ext_reset_in] [get_bd_pins zynq7010/FCLK_RESET0_N]

  # Create address segments
  assign_bd_address -offset 0x41200000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq7010/Data] [get_bd_addr_segs gpio_leds/S_AXI/Reg] -force
  assign_bd_address -offset 0x41210000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq7010/Data] [get_bd_addr_segs gpio_btns/S_AXI/Reg] -force
  assign_bd_address -offset 0x40000000 -range 0x00002000 -target_address_space [get_bd_addr_spaces zynq7010/Data] [get_bd_addr_segs bram_ctrl/S_AXI/Mem0] -force
  assign_bd_address -offset 0x41220000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq7010/Data] [get_bd_addr_segs gpio_swtchs/S_AXI/Reg] -force

  # Perform GUI Layout
  regenerate_bd_layout -layout_string {
   "ActiveEmotionalView":"Default View",
   "Default View_ScaleFactor":"0.716667",
   "Default View_TopLeft":"-43,0",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.0.21  2019-05-29 bk=1.5064 VDI=41 GEI=36 GUI=JA:9.0 TLS
#  -string -flagsOSRD
preplace port DDR -pg 1 -lvl 5 -x 1360 -y 310 -defaultsOSRD
preplace port FIXED_IO -pg 1 -lvl 5 -x 1360 -y 330 -defaultsOSRD
preplace port leds_4bits -pg 1 -lvl 5 -x 1360 -y 500 -defaultsOSRD
preplace port btns_4bits -pg 1 -lvl 5 -x 1360 -y 210 -defaultsOSRD
preplace port sws_4bits -pg 1 -lvl 5 -x 1360 -y 640 -defaultsOSRD
preplace inst zynq7010 -pg 1 -lvl 1 -x 240 -y 350 -defaultsOSRD
preplace inst gpio_leds -pg 1 -lvl 3 -x 940 -y 500 -defaultsOSRD
preplace inst zynq7010_axi_periph -pg 1 -lvl 2 -x 610 -y 510 -defaultsOSRD
preplace inst rst_zynq7010_100M -pg 1 -lvl 1 -x 240 -y 560 -defaultsOSRD
preplace inst gpio_btns -pg 1 -lvl 3 -x 940 -y 220 -defaultsOSRD
preplace inst gpio_swtchs -pg 1 -lvl 3 -x 940 -y 640 -defaultsOSRD
preplace inst bram_ctrl -pg 1 -lvl 3 -x 940 -y 80 -defaultsOSRD
preplace inst bram_gen -pg 1 -lvl 4 -x 1210 -y 80 -defaultsOSRD
preplace netloc zynq7010_FCLK_CLK0 1 0 3 30 450 450 700 790
preplace netloc zynq7010_FCLK_RESET0_N 1 0 2 40 460 440
preplace netloc rst_zynq7010_100M_peripheral_aresetn 1 1 2 460 690 800
preplace netloc gpio_btns_ip2intc_irpt 1 0 4 20 250 NJ 250 780J 300 1080
preplace netloc processing_system7_0_DDR 1 1 4 NJ 310 NJ 310 NJ 310 NJ
preplace netloc processing_system7_0_FIXED_IO 1 1 4 NJ 330 NJ 330 NJ 330 NJ
preplace netloc axi_gpio_0_GPIO 1 3 2 NJ 500 NJ
preplace netloc zynq7010_M_AXI_GP0 1 1 1 460 350n
preplace netloc zynq7010_axi_periph_M00_AXI 1 2 1 N 480
preplace netloc axi_gpio_0_GPIO1 1 3 2 NJ 210 NJ
preplace netloc zynq7010_axi_periph_M01_AXI 1 2 1 770 200n
preplace netloc axi_gpio_0_GPIO2 1 3 2 NJ 640 NJ
preplace netloc zynq7010_axi_periph_M02_AXI 1 2 1 780 520n
preplace netloc bram_ctrl_BRAM_PORTA 1 3 1 N 70
preplace netloc bram_ctrl_BRAM_PORTB 1 3 1 N 90
preplace netloc zynq7010_axi_periph_M03_AXI 1 2 1 760 60n
levelinfo -pg 1 0 240 610 940 1210 1360
pagesize -pg 1 -db -bbox -sgen 0 0 1490 720
"
}
...
# End of cr_bd_zybo()
cr_bd_zybo ""
set_property REGISTERED_WITH_MANAGER "1" [get_files zybo.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files zybo.bd ] 



# Proc to create BD zybo_base_system
proc cr_bd_zybo_base_system { parentCell } {

  # CHANGE DESIGN NAME HERE
  set design_name zybo_base_system
...
preplace inst bram_ctrl -pg 1 -lvl 3 -x 940 -y 80 -defaultsOSRD
preplace inst bram_gen -pg 1 -lvl 4 -x 1210 -y 80 -defaultsOSRD
preplace netloc zynq7010_FCLK_CLK0 1 0 3 30 460 430 700 780
preplace netloc zynq7010_FCLK_RESET0_N 1 0 2 40 450 420
preplace netloc rst_zynq7010_100M_peripheral_aresetn 1 1 2 440 690 790
preplace netloc gpio_btns_ip2intc_irpt 1 0 4 20 250 NJ 250 770J 300 1070
preplace netloc processing_system7_0_FIXED_IO 1 1 4 NJ 330 NJ 330 NJ 330 NJ
preplace netloc zynq7010_axi_periph_M03_AXI 1 2 1 750 60n
preplace netloc zynq7010_axi_periph_M02_AXI 1 2 1 770 520n
preplace netloc zynq7010_axi_periph_M01_AXI 1 2 1 760 200n
preplace netloc bram_ctrl_BRAM_PORTA 1 3 1 N 70
preplace netloc axi_gpio_0_GPIO 1 3 2 NJ 500 NJ
preplace netloc zynq7010_axi_periph_M00_AXI 1 2 1 N 480
preplace netloc axi_gpio_0_GPIO1 1 3 2 NJ 210 NJ
...
preplace netloc axi_gpio_0_GPIO2 1 3 2 NJ 640 NJ
preplace netloc bram_ctrl_BRAM_PORTB 1 3 1 N 90
preplace netloc zynq7010_M_AXI_GP0 1 1 1 440 350n
levelinfo -pg 1 0 240 610 940 1210 1360
pagesize -pg 1 -db -bbox -sgen 0 0 1480 720
"
}
...
# End of cr_bd_zybo_base_system()
cr_bd_zybo_base_system ""
set_property REGISTERED_WITH_MANAGER "1" [get_files zybo_base_system.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files zybo_base_system.bd ] 
