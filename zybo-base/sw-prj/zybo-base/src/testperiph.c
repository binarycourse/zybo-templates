...
int main () 
{
...

   {
      ...
      print("\r\nRunning GpioInputExample() for gpio_btns...\r\n");

      u32 DataRead;
      
      status = GpioInputExample(XPAR_GPIO_BTNS_DEVICE_ID, &DataRead);
   ...
   }
   {
      ...
      Status = GpioIntrExample(&intc, &gpio_btns_Gpio, \
                               XPAR_GPIO_BTNS_DEVICE_ID, \
                               XPAR_FABRIC_GPIO_BTNS_IP2INTC_IRPT_INTR, \
...

   {
      ...
      status = GpioOutputExample(XPAR_GPIO_LEDS_DEVICE_ID,4);
...

   {
      ...
      print("\r\nRunning GpioInputExample() for gpio_swtchs...\r\n");

      u32 DataRead;
      
      status = GpioInputExample(XPAR_GPIO_SWTCHS_DEVICE_ID, &DataRead);
